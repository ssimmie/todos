...
/**
 * CDK Application entry point for Todos infrastructure. This application creates all AWS resources
 * needed to run the Todos application privately.
 */
public final class TodosInfrastructureApp {
  ...
  /**
   * Creates environment configuration from system properties or environment variables. No hardcoded
   * account/region values to prevent secrets in code.
   */
