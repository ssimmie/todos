...
public class EcsStack extends Stack {
  ...
  /**
   * Creates Fargate task definition with secure environment configuration. No secrets hardcoded -
   * all sensitive data via Secrets Manager.
   */
  private FargateTaskDefinition createTaskDefinition(final String keyspaceName) {
    FargateTaskDefinition taskDefinition =
        FargateTaskDefinition.Builder.create(this, "TodosTaskDefinition")
    ...
    taskDefinition.addToTaskRolePolicy(
        PolicyStatement.Builder.create()
            ...
            .actions(
                List.of(
                    "cassandra:Select", "cassandra:Insert", "cassandra:Update", "cassandra:Delete"))
            .resources(List.of("*"))
            .build());

    // Create log group for application logs
    LogGroup logGroup =
        LogGroup.Builder.create(this, "TodosLogGroup")
