 ...
 * Creates managed Cassandra-compatible database with tables for Todos application.
 */
public class KeyspacesStack extends Stack {
    ...
    private CfnKeyspace createKeyspace() {
        return CfnKeyspace.Builder.create(this, "TodosKeyspace")
    ...
    private void createChecklistTable(final CfnKeyspace keyspace) {
        CfnTable.Builder.create(this, "ChecklistTable")
                ...
                .tableName("checklist")
                .partitionKeyColumns(List.of(
                        CfnTable.ColumnProperty.builder()
                                .columnName("id")
                                .columnType("text")
                                .build()
                ))
                .regularColumns(List.of(
                        CfnTable.ColumnProperty.builder()
                                .columnName("name")
                                .columnType("text")
                                .build(),
